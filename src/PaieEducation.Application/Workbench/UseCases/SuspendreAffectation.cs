...
/// <summary>
/// Use case Workbench (Phase 5, tâche 5, J3H §7) : suspend une affectation
/// acceptée (<c>ACCEPTEE → SUSPENDUE</c>). Réactivation via
/// <see cref="AccepterSuggestion"/> (même cible <c>ACCEPTEE</c> sur le
/// diagramme d'état). Aucune précondition sur l'état de départ ; échoue
/// explicitement si la ligne est déjà <c>SUPPRIMEE</c>
/// (<see cref="IAgentRubriqueRepository.ChangerStatutAsync"/>).
/// </summary>
public sealed class SuspendreAffectation
{
    ...
    public SuspendreAffectation(IAgentRubriqueRepository agentRubriques, IClock clock)
    {
