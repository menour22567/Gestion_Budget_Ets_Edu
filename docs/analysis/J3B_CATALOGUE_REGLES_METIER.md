...
| RM-047 ⛳ | Ind. direction d'établissement (`DIR_ETAB`, J3C §2) : réservée aux directeurs **en exercice effectif**, montant selon le type d'établissement (primaire/collège/lycée). **Non codée (16/07/2026)** : le critère « en exercice effectif » est un `AgentAttribut` (D3, J3H § 4), qui suppose `AgentAttributs`/`Agents` — absentes avant Phase 5. La seeder sans cette condition (grade seul) paierait à tort un directeur hors exercice effectif — abstention (ADR-0009) plutôt qu'approximation. | Art. 9 bis 1 D.ex. 15-271 |
...
| RM-053 | **✅ Résolu (15/07/2026, Q-08).** Enseignants contractuels (CSV lignes 130-132) : arrêté MEN fixant 6 primes/indemnités — qualification, PAPP, documentation pédagogique, **ISSRP**, forfaitaire compensatoire, indemnité de zone — « calculées selon le diplôme, le grade correspondant et le lieu d'exercice ». Le D.p. 07-308/D.ex. 10-136 (emplois ouvriers/services) ne s'applique **pas** à cette population, distincte du `Type_Contrat=CONTRACTUEL` générique. | Arrêté 6 primes enseignants contractuels ; D.ex. 10-78 art. 3/7/8/9 bis ; D.ex. 08-70 art. 2/3/4 |
