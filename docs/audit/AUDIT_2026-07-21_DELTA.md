...
| Items P0–P17 non commencés | **6** (P8, P10, P11, P13, P14, P15, P16, P17 — les 4 derniers sont bloqués/explicites) |
...
| **P22** | §1 P3 manquant | Clore Lot 2.2 : doc d'hypothèses + scénarios IRG 2022 + non-régression explications | 3 | M | aucune |
| **P23** | §1 P1 manquant | Passage ADR-0010 à « Accepté » (validation utilisateur) | 4 | XS | décision utilisateur |
